...
export default function SeriesDetail() {
  ...
  const resourceColumns: TableColumnsType<FileResource> = [
    ...
    { title: t('series.subtitleGroup'), dataIndex: 'subtitle_groups', key: 'subtitle_groups', width: 180, render: (_: unknown, r: FileResource) => (r.subtitle_groups?.length ? r.subtitle_groups : (r.subtitle_group ? [r.subtitle_group] : [])).join(' & ') || '—' },
